...
namespace amsim {
SimulationBuilder::SimulationBuilder() : status_() {}

SimulationBuilder& SimulationBuilder::simulation(
    std::size_t n_gen,
    std::size_t n_ind,
    std::string out_dir,
...
SimulationBuilder& SimulationBuilder::genome(
    std::size_t n_loc,
...
SimulationBuilder& SimulationBuilder::phenome(
    std::size_t n_pheno,
...
SimulationBuilder& SimulationBuilder::mating(
    MatingType type,

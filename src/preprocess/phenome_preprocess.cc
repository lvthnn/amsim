...
void OptimisePhenotypeArchitecture::randomState() {
...
void OptimisePhenotypeArchitecture::computeInitObjective() {
  diff_cur_ = pheno_effects_.transpose() * pheno_effects_ - gen_cor_;
  err_frob_ = diff_cur_.squaredNorm();
  err_frob_opt_ = err_frob_;
}

void OptimisePhenotypeArchitecture::printObjective() {
  std::cerr << diff_cur_ << "\n\n";
  std::cerr << "err_frob_: " << err_frob_ << "\n";
  std::cerr << "err_frob_opt_: " << err_frob_opt_ << "\n";
}

void OptimisePhenotypeArchitecture::computeExpected() {
  expected_ = pheno_effects_.transpose() * pheno_effects_;
}

void OptimisePhenotypeArchitecture::proposeState() {
...
void OptimisePhenotypeArchitecture::updateState() {
...
void OptimisePhenotypeArchitecture::operator()() {
  randomState();

...
PYBIND11_MODULE(_core, m) {
  ...
  py::enum_<amsim::MatingType>(m, "_MatingType")
    .value("RANDOM", amsim::MatingType::RANDOM)
    .value("ASSORTATIVE", amsim::MatingType::ASSORTATIVE)
    .export_values();

  py::enum_<amsim::ComponentType>(m, "_ComponentType")
  ...
  m.def("_comp_mean", &amsim::metrics::comp_mean,
        py::arg("n_phenotypes"),
        py::arg("component_type"),
        "Create component mean metric");

  m.def("_comp_var", &amsim::metrics::comp_var,
        py::arg("n_phenotypes"),
        py::arg("component type"),
        "Create component variance metric");

  m.def("_comp_cor", &amsim::metrics::comp_cor,
        py::arg("n_phenotypes"),
        py::arg("component_type"),
        "Create component correlation matrix metric");

  m.def("_comp_xcor", &amsim::metrics::comp_xcor,
        py::arg("n_phenotypes"),
        py::arg("component_type"),
        "Create between-mate component correlation matrix metric");

  m.def("_latent_h2", &amsim::metrics::latent_h2,
        py::arg("n_phenotypes"),
        "Create latent phenotype heritability metric");

  m.def("_latent_comp_cor", &amsim::metrics::latent_comp_cor,
        py::arg("n_phenotypes"),
        py::arg("component_type"),
        "Create latent component correlation matrix metric");

  m.def("_latent_comp_xcor", &amsim::metrics::latent_comp_xcor,
        py::arg("n_phenotypes"),
        py::arg("component_type"),
